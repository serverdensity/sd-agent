...
Requires: python36 >= 3.6, sysstat, libyaml, %{name}-forwarder, %{name}-sd-cpu-stats, %{name}-network, %{name}-disk
...
python3.6 virtualenv.py -p python3 --no-site-packages --no-pip --no-setuptools %{__venv}
